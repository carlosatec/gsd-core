<!-- GSD-SESSION-CONTEXT -->
> **GSD Active State**: Phase: Phase 22 (Holistic Token Telemetry, Multi-Command Observability & Workflow Context Tracking) | Status: Complete
> **Decisions**: **D-01 [Architecture]:** Analisador AST nativo em TypeScript sem dependência de Python ou compiladores externos.; **D-02 [Docs]:** Documentação viva incremental (`ARCHITECTURE.md`, `APIS.md`) sincronizada com o código.; **D-03 [Context]:** JIT context injection para montar prompts cirúrgicos baseados no grafo de dependências.; **D-04 [Guardrails]:** Pre-flight static verification + self-healing loop automático em caso de falhas de teste.; **D-111 [Transactional Lock]:** withFileLockSync em telemetry.json.; **D-112 [Idempotency]:** invocationId e deduplicação.; **D-113 [Targeted Review]:** Escopo seletivo e calibrador compartilhado.; **D-114 [CLI Auto-Estimator]:** Cálculo via arquivos reais sem variáveis mágicas de shell.; **D-115 [Strict Sanitization]:** Enum e inteiros não negativos.; **D-116 [Stable Dashboard]:** 65 colunas e estado pré-executivo.; **D-117 [Hub CLI Seam]:** Roteamento canônico no gsd-tools.; **D-118 [Tokens Alignment]:** Invocar dashboard nativo em tokens.md.; **D-119 [Root-Relative Guardrails]:** Ancoragem em rootDir.; **D-120 [Flexible Phase ID]:** Resolução dinâmica de argumentos.; **D-121 [Dual-Mode Review]:** Suporte a --full com scopeMode transparente.
