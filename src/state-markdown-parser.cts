 ...
 */
export function parseProsePhaseField(value: string | null | undefined): { phase: string | null; name: string | null } {
 ...
 */
export function parseProseLastActivityField(value: string | null | undefined): { date: string | null; description: string | null } {
  if (!value || typeof value !== 'string') {
 ...
 */
export function extractRetiredPhaseNumbers(scope: string): Set<string> {
 ...
 */
export function sanitizeMarkdownHeader(text: string): string {
