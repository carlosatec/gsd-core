...
Versões por idioma: [English](../README.md) · [Português (pt-BR)](README.md)

---

## Tutoriais

- [Tutorial Prático: Dominando o GSD Core Nexus 3.4](tutorials/tutorial-pratico.md) ([English](../tutorials/practical-tutorial.md)) 🔥
