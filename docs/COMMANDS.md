...
## Canonical Unified Interface (GSD 3.0)

Starting in GSD 3.0, the public command surface is strictly consolidated into **10 Canonical Unified Commands** (with all specialized playbooks loaded on-demand via execution context):
