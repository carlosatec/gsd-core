...
const capabilities = {
  ...
  "antigravity": {
    ...
    "version": "2.8.1",
    "title": "Antigravity",
    "description": "Google Antigravity IDE — global customizations under ~/.gemini/config; Gemini hook event dialect; flat skill layout; tier-1 support.",
    "tier": "core",
    "requires": [],
    "engines": {
      "gsd": ">=1.6.0"
  ...
  "deepseek-harness": {
    ...
    "description": "DeepSeek Harness (dsh) — Cordis micro-kernel plugin architecture; commands, skills & agents artifact layout; settings-json hook surface; tier-2 support.",
    "tier": "core",
    "requires": [],
    "engines": {
      "gsd": ">=1.6.0"
